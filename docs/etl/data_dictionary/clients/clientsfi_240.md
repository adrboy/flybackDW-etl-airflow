# 📖 Data Dictionary — dag_clientsfi_240

**DAG:** `dag_clientsfi_240`  
**Objetivo:** ETL incremental clientes FI desde MariaDB 240 → SQL Server Silver  
**Origen:** `MariaDB 192.168.10.240` — `db_general.viewclientsfi`  
**Destino:** `SQL Server 192.168.10.244` — `source.clientsfi`  
...
|---|---|---|
| SELECT | `dags/sql/clients/select_clientsfi_240.sql` | 20 columnas + CAST(capdata AS DATE) |
| INSERT | `dags/sql/clients/insert_clientsfi_240.sql` | 23 columnas con placeholders `?` |
