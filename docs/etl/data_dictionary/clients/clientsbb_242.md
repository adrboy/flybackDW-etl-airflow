# 📖 Data Dictionary — dag_clientsbb_242

**DAG:** `dag_clientsbb_242`  
**Objetivo:** ETL incremental clientes BB desde MariaDB 242 → SQL Server Silver  
**Origen:** `MariaDB 192.168.10.242` — `db_general.viewclientsbb`  
**Destino:** `SQL Server 192.168.10.244` — `source.clientsbb`  
...
|---|---|---|
| SELECT | `dags/sql/clients/select_clientsbb_242.sql` | 20 columnas + CAST(capdata AS DATE) |
| INSERT | `dags/sql/clients/insert_clientsbb_242.sql` | 23 columnas con placeholders `?` |
