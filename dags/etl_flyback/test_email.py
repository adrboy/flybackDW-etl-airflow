...
# ══════════════════════════════════════════════
# IMPORTANTE: el bloque if __name__ == "__main__"
# evita que Airflow ejecute este código al escanear
# la carpeta dags/. Solo se ejecuta si se llama
# directamente: python test_email.py
# ══════════════════════════════════════════════
