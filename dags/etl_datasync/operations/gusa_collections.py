...
# Origen   : 192.168.10.240  (financiamiento) — MariaDB_gusa
# Destino  : 192.168.10.242  (db_general) — MariaDB (CONN_GLOBAL)
# Versión  : 4.0 — 2026-08-03
# Cambios  : Conexión dedicada MariaDB_gusa
# ═══════════════════════════════════════════════════════
from common.db_connections import CONN_GUSA, CONN_GLOBAL
