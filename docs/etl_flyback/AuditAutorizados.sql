...
-- ============================================================
-- NOTA IMPORTANTE — DIFERENCIAS 2015-2017:
-- Las diferencias positivas en 2015-2017 son ruido historico
-- causado por la practica de reciclar el mismo indice en
-- pago_redeem para dos o mas pagos diferentes (mala practica
-- del periodo). El PRIMARY KEY de tblInicioAutorizados impide
-- duplicados en destino — por eso origen siempre contara mas.
-- A partir de 2018 todas las diferencias deben ser 0.
-- No requieren accion correctiva.
-- ============================================================
SELECT origen.anio
     , origen.mes
     , origen.NomMes
...
FROM (
    ...
    AND    A.status_p >= 2              -- mismo filtro del DAG
