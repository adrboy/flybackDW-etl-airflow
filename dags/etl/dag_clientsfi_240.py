...
def etl_clientsfi():
    ...
    try:
        ...
        mensaje_log.append(f"[DAG: dag_clientsfi_240] MAX clientid destino: {max_id}")
        ...
        mensaje_log.append(f"[DAG: dag_clientsfi_240] Filas insertadas: {filas}")
        estado = "SUCCESS"

    except Exception as e:
        mensaje_log.append(f"[DAG: dag_clientsfi_240] ERROR: {str(e)}")
        mensaje_error = str(e)
        raise
        ...
        try:
            ...
            escribir_log_txt(LOG_PATH, "clientsfi", "\n".join(mensaje_log))
