# 📖 Data Dictionary — dag_clientsml_242

**DAG:** `dag_clientsml_242`  
**Objetivo:** ETL incremental clientes ML desde MariaDB 242 → SQL Server Silver  
**Origen:** `MariaDB 192.168.10.242` — `db_general.viewclientsml`  
**Destino:** `SQL Server 192.168.10.244` — `source.clientsml`  
...
|---|---|---|
| SELECT | `dags/sql/clients/select_clientsml_242.sql` | 20 columnas + CAST(capdata AS DATE) |
| INSERT | `dags/sql/clients/insert_clientsml_242.sql` | 23 columnas con placeholders `?` |
